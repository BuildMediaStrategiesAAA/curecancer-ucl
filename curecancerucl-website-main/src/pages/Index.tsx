...
const impactAreas: ApartmentProps[] = [
  {
    ...
    description: "High-throughput nanopore sequencing, accessible and portable.",
    price: 250,
    capacity: 1,
    size: 100,
  ...
  },
  {
    ...
    description: "5-laser, 30+ parameter flow cytometer.",
    price: 100,
    capacity: 2,
    size: 200,
  ...
  },
  {
    ...
    description: "Improve throughput and ergonomics.",
    price: 50,
    capacity: 3,
    size: 150,
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-fade-in [animation-delay:300ms]">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden">
                  <img 
                    src="https://raw.githubusercontent.com/BuildMediaStrategies/ucl-cancer-assets/3e7d28f2dd44f2acbf5c353c4dbc482b05649cb6/rphalf-2021-image.jpg"
                ...
                <div className="absolute -bottom-6 -left-6 w-2/3 rounded-2xl overflow-hidden shadow-xl">
                  <img 
                    src="https://raw.githubusercontent.com/BuildMediaStrategies/ucl-cancer-assets/3e7d28f2dd44f2acbf5c353c4dbc482b05649cb6/ucl-cancer-institute_content_e5962e83.webp"
                ...
                <div className="absolute -top-6 -right-6 w-1/2 rounded-2xl overflow-hidden shadow-xl">
                  <img 
                    src="https://raw.githubusercontent.com/BuildMediaStrategies/ucl-cancer-assets/3e7d28f2dd44f2acbf5c353c4dbc482b05649cb6/485534538_18493127119054353_8264469170580512409_n.jpg"
        ...
        {/* CTA Section */}
        <section className="relative py-24 bg-primary/5 overflow-x-clip">
          <div className="container">
