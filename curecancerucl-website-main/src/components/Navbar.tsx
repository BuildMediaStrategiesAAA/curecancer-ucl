...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "UCL Institute", path: "/ucl-institute" },
    { name: "Team", path: "/team" },
      ...
      <nav className="container flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <Link to="/" className="flex items-center">
            <img 
              src="/ucl-cancer-logo.png" 
              alt="Cure Cancer @ UCL Logo" 
              className="h-16 sm:h-20 md:h-24 lg:h-28 w-auto object-contain max-w-[200px] sm:max-w-[250px] md:max-w-[300px] hover:opacity-80 transition-opacity duration-200"
            />
          </Link>
        </div>
