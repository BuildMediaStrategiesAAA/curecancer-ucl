...
export default function ApartmentCard({ apartment }: { apartment: ApartmentProps }) {
  ...
  const translatedName = t.apartmentDescriptions[apartment.id]?.name || apartment.name;
  const translatedDescription = t.apartmentDescriptions[apartment.id]?.description || apartment.description;
